            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    try
                    {
                        ...
                        modelUser.AddUser(dbconAPP, modelUser);
                    }
                    catch (Exception ex)
                    {
                        ViewBag.AccountRegisterError += "ERROR: " + ex.Message + " (Account.Register[POST]).";
                        return View(model);
                    }
                    finally
                    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        {
                            ViewBag.AccountRegisterError += "ERROR: " + ex.Message + " (Account.ExternalLoginConfirmation[POST]).";
                            return View(model);
                        }
                        finally
                        {
